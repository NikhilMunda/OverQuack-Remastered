...
class WSGIServer:
    ...
    def update_poll(self):
        ...
        if self._client_sock:
            try:
                ...
                print(f"Socket error during poll: {e}")
    ...
    def finish_response(self, result):
        """
        Send response and handle client disconnection gracefully.
        """
        try:
            ...
            for data in result:
                ...
                while bytes_sent < len(data):
                    try:
                        ...
                        if ex.errno in (32, 104, 54):  # EPIPE, ECONNRESET, etc.
                            print("Client disconnected during send.")
                            return
                        elif ex.errno == 11:  # EAGAIN
                            continue
                        else:
                            raise
        except OSError as ex:
